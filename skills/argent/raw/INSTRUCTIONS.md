# Quarantined Argent Developer Instructions

> Preserved verbatim from the repository `.codex/config.toml` `developer_instructions` value on 2026-08-16.
> This is raw source material, not an active skill contract. Do not execute it unless a user explicitly asks to review or rebuild it.
