...
Codex0.151.0, Next16.3.4 and React19.2.8. Docker Desktop or Linux Docker/Compose,
...
are installed before the paid agent; package-lock.json preserves resolution.
...
The preview Compose service owns npm start after the agent finishes. A nohup
